  ...
  methods: {
    getData() {
      this.axios(
        ...
        Object.entries(chartData).forEach(element => {
          // eslint-disable-next-line no-unused-vars
          Object.entries(element).forEach(([key, array]) => {
            // eslint-disable-next-line no-unused-vars
            console.log(key, 'KEY', array, 'array')
            Object.entries(array).forEach(([keyName, ele]) => {
              // eslint-disable-next-line no-unused-vars
              console.log(keyName.slice(3), 'ele', ele)
              // xvalue.push(keyOuter)
              series.push({
                data: ele,
                name: key.slice(3)
        ...
        console.log(chartData, 'chart', xvalue, series)
